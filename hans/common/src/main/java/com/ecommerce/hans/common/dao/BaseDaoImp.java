...
import com.ecommerce.hans.common.persistance.JPAQuery;
import com.ecommerce.hans.common.persistance.BaseRepo;
...
public abstract class BaseDaoImp<T, K extends BaseRepo> implements IBaseDao<T> {
    ...
    private final TypeToken<K> typeToken = new TypeToken<K>(getClass()) { };
